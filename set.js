...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~fS5Wukn66N2icAmMytWt", // Add sess Id here especially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "+256742810290", // Only 1 owner Number Here, others Add to sudo numbers...
